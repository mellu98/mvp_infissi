    ...
    data: {
      ...
      settings: {
        create: {
          ...
          postalCode: '27030',
          country: 'Italia',
          email: 'info@linkinfissi.demo',
          phone: '+39 0382 000000',
          website: 'https://linkinfissi.demo',
          defaultVatRate: 22,
          currency: 'EUR',
          quoteValidityDays: 30,
          quoteNumberPrefix: '',
          quoteTerms:
            'Validità offerta 30 giorni. Misure definitive da confermare in sopralluogo. Prezzi demo non vincolanti.',
          contractTerms:
            'Contratto soggetto ad accettazione scritta, acconto concordato e verifica tecnica in cantiere.',
